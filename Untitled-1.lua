...
for i,v in pairs(keys) do
    if counter == #keys then
        -- no key
        keys = ""
        game.Players.LocalPlayer:Kick("iheretuu123")
    else
        if v == getgenv().Key then 
            -- check succes
            print("Succesfully, enjoy :]")
            loadstring(game:HttpGet("https://raw.githubusercontent.com/xexzeroz/XexzerozNew/main/new%20versoin.lua"))()
...
function scripthub()
    ...
    local foldername = "XEXZEROZ HUBB "
    ...
    local library = loadstring(game:HttpGet("https://pastebin.com/raw/Lr6H6RXe"))()
    local Wait = library.subs.Wait
    
    local PepsisWorld = library:CreateWindow({
        Name = "XEXZEROZ HUB",
        Themeable = {
        Info = "Discord Server: XEXZEROZ HUB"
        }
    })
